...
if __name__ == '__main__':
   ...
   for chordType in chord_list:
       ...
       for track in filelist:
            ...
            try:
                weighted_score = mir_eval.chord.weighted_accuracy(mir_eval.chord.mirex(filtered_ref_labels, filtered_est_labels), durations)
                mirex_scores.append(weighted_score)
                counter += 1
